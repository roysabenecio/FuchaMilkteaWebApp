            ...
            modelBuilder.Entity("Fucha.DomainClasses.PORecord", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = 0,
                            DatePurchased = "Sunday, 11 December 2022",
                            Measure = 100.0,
                            MeasurementUnit = 1,
                            Price = 100.0,
                            PurchaseRecordId = 1,
            ...
            modelBuilder.Entity("Fucha.DomainClasses.Stock", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = 0,
                            DateAdded = "Sunday, 11 December 2022",
                            IsRemoved = false,
                            Measure = 2.0,
                            MeasurementUnit = 1,
                            Name = "Okinawa",
            ...
            modelBuilder.Entity("Fucha.DomainClasses.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsRemoved = false,
                            LastName = "Sabenecio",
                            PasswordHash = new byte[] { 196, 122, 40, 239, 200, 150, 53, 211, 223, 19, 106, 98, 49, 1, 10, 45, 73, 164, 2, 47, 98, 178, 206, 94, 240, 236, 34, 3, 194, 15, 213, 10 },
                            PasswordSalt = new byte[] { 186, 238, 174, 180, 179, 150, 53, 212, 105, 169, 60, 25, 205, 132, 222, 206, 103, 151, 37, 126, 2, 117, 217, 181, 182, 173, 173, 67, 103, 22, 86, 63, 142, 76, 4, 72, 230, 229, 195, 90, 212, 89, 245, 180, 180, 120, 149, 6, 176, 217, 153, 87, 110, 111, 67, 254, 141, 160, 109, 37, 128, 12, 85, 45 },
                            Role = "Admin",
                            UserName = "r",
                            UserStatus = "Approved"
                        });
