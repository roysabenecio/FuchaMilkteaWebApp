...
{
    public class DeductStockMeasureCommand : IRequest<bool> 
    {
    ...
    public class DeductStockMeasureCommandHandler : IRequestHandler<DeductStockMeasureCommand, bool> 
    {
        private readonly IFuchaMilkteaContext _context;
        public DeductStockMeasureCommandHandler(IFuchaMilkteaContext context)
        {
            _context = context;
        }

        public Task<bool> Handle(DeductStockMeasureCommand request, CancellationToken cancellationToken)
        {
