        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AddOnPrice = table.Column<double>(type: "double", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<double>(type: "double", nullable: false),
                    AddOn = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AddOnPrice = table.Column<double>(type: "double", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<double>(type: "double", nullable: false),
                    DatePurchased = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiredMeasure = table.Column<double>(type: "double", nullable: false),
                    MeasurementUnit = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    ItemQuantity = table.Column<int>(type: "int", nullable: false),
                    DateSold = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateAdded = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    LastRestocked = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    SupplierId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, "Thursday, 24 November 2022", 100.0, 1, 100.0, 1, 1 },
                    { 2, 0, "Thursday, 24 November 2022", 50.0, 1, 50.0, 1, 2 },
                    { 3, 1, "Thursday, 24 November 2022", 50.0, 1, 50.0, 2, 4 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Thursday, 24 November 2022", 2, 1, 100.0, 1 },
                    { 2, "Thursday, 24 November 2022", 1, 3, 50.0, 1 }
                });
            ...
            migrationBuilder.InsertData(
                table: "Stocks",
                columns: new[] { "Id", "AddOnId", "Category", "DateAdded", "IsRemoved", "LastRestocked", "Measure", "MeasurementUnit", "MenuId", "Status", "SupplierId" },
                values: new object[,]
                {
                    { 1, null, 0, null, false, null, 5.0, 1, 1, null, 1 },
                    { 2, null, 0, null, false, null, 5.0, 1, 2, null, 1 },
                    { 3, null, 0, null, false, null, 5.0, 1, 3, null, 2 },
                    { 10, 3, 1, null, false, null, 5.0, 0, null, null, 3 },
                    { 41, null, 2, null, false, null, 100.0, 3, 41, null, 10 },
                    { 42, null, 2, null, false, null, 100.0, 3, 42, null, 10 },
                    { 43, null, 2, null, false, null, 100.0, 3, 43, null, 10 },
                    { 44, null, 2, null, false, null, 100.0, 3, 44, null, 10 },
                    { 45, null, 2, null, false, null, 100.0, 3, 45, null, 10 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "157 Josefa Drive Brgy, Corazon De Jesus, San Juan City", 9178077279L, "Thursday, 24 November 2022", "In joy" },
                    { 2, "208A Banawe St., Brgy Tatalon, Quezon City", 9175858100L, "Thursday, 24 November 2022", "PHNI Bubble Tea Store" },
                    { 3, "San Juan Manila", 9171284151L, "Thursday, 24 November 2022", "MSCS PrimeGoods, Inc." },
                    { 10, "#24 F Pasco Aveue Santolan, Pasig, Philippines", 9955823086L, "Thursday, 24 November 2022", "Pizza Crust" }
                });
