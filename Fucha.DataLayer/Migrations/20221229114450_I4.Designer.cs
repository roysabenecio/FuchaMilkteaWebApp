            ...
            modelBuilder.Entity("Fucha.DomainClasses.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsRemoved = false,
                            LastName = "Admin",
                            PasswordHash = new byte[] { 42, 169, 211, 171, 84, 60, 6, 148, 201, 59, 38, 145, 150, 248, 166, 209, 73, 155, 94, 27, 86, 152, 37, 30, 56, 82, 68, 69, 47, 245, 212, 35 },
                            PasswordSalt = new byte[] { 20, 189, 214, 131, 139, 213, 176, 175, 52, 155, 176, 87, 109, 96, 139, 94, 42, 181, 101, 5, 46, 215, 90, 62, 208, 173, 199, 16, 23, 113, 252, 136, 223, 65, 247, 51, 128, 142, 174, 96, 162, 154, 184, 14, 238, 134, 161, 80, 248, 59, 65, 118, 215, 105, 99, 103, 29, 3, 235, 42, 19, 71, 157, 250 },
                            Role = "Admin",
                            UserName = "admin",
                            UserStatus = "Approved"
                        });
