...
namespace Fucha.DataLayer.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Items",
                columns: new[] { "Id", "ItemCategory", "ItemStatus", "MeasurementUnit", "Name", "Quantity" },
                values: new object[,]
                {
                    { 1, "Milk Tea Powder", null, "Kilograms", "Okinawa Powder", 5.0 },
                    { 2, "Utensil", null, "Pieces", "Milk Tea Cup", 10.0 }
                });
            ...
            migrationBuilder.InsertData(
                table: "Menus",
                columns: new[] { "Id", "MenuCategoryId", "Name" },
                values: new object[] { 20, 3, "Spam & Japanese Sausage" });
