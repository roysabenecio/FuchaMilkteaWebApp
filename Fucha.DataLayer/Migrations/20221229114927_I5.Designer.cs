            ...
            modelBuilder.Entity("Fucha.DomainClasses.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsRemoved = false,
                            LastName = "Admin",
                            PasswordHash = new byte[] { 183, 160, 11, 7, 157, 89, 107, 78, 86, 104, 247, 14, 72, 97, 40, 28, 246, 158, 103, 5, 188, 32, 170, 13, 104, 111, 255, 171, 66, 52, 223, 8 },
                            PasswordSalt = new byte[] { 164, 139, 46, 2, 152, 21, 241, 218, 96, 248, 62, 211, 88, 116, 213, 109, 151, 42, 165, 13, 156, 151, 194, 168, 93, 45, 253, 191, 136, 117, 99, 3, 118, 247, 188, 16, 102, 4, 68, 180, 62, 152, 19, 214, 93, 4, 6, 178, 61, 72, 0, 100, 191, 60, 14, 175, 114, 209, 130, 179, 194, 43, 34, 114 },
                            Role = "Admin",
                            UserName = "admin",
                            UserStatus = "Approved"
                        });
