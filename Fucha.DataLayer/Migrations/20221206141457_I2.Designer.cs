...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fucha.DataLayer.DTOs.UserSampleDTO", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Fucha.DomainClasses.PORecord", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = 0,
                            DatePurchased = "Tuesday, 06 December 2022",
                            Measure = 100.0,
                            MeasurementUnit = 1,
                            Price = 100.0,
                            PurchaseRecordId = 1,
            ...
            modelBuilder.Entity("Fucha.DomainClasses.Stock", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = 0,
                            DateAdded = "Tuesday, 06 December 2022",
                            IsRemoved = false,
                            Measure = 15.0,
                            MeasurementUnit = 1,
                            Name = "Okinawa",
            ...
            modelBuilder.Entity("Fucha.DomainClasses.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsRemoved = false,
                            LastName = "Sabenecio",
                            PasswordHash = new byte[] { 191, 41, 66, 54, 232, 85, 230, 21, 50, 30, 198, 111, 10, 71, 215, 113, 170, 145, 39, 75, 69, 14, 145, 191, 197, 224, 139, 147, 136, 134, 52, 218 },
                            PasswordSalt = new byte[] { 102, 82, 102, 208, 115, 80, 155, 182, 252, 78, 23, 136, 63, 57, 53, 239, 53, 197, 74, 197, 148, 95, 69, 240, 243, 188, 33, 250, 93, 251, 193, 79, 47, 119, 106, 167, 69, 71, 0, 140, 138, 187, 50, 117, 158, 251, 143, 162, 127, 30, 246, 73, 73, 58, 40, 132, 100, 100, 103, 246, 137, 180, 85, 98 },
                            Role = "Admin",
                            UserName = "r",
                            UserStatus = "Approved"
                        });
